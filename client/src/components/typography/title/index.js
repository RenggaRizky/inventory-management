...
const TitleRackList = ({ color = "#111928", fontsize = "1rem", fontweight = "400", lineheight = "25px", margin = 0, padding = 0, texttransform = "none", textalign, ...props }) => {
    const title = {
        fontFamily: '"Poppins", sans-serif',
        fontSize: fontsize,
        fontWeight: fontweight,
