        ...
        <div className={styles.wrapper}>
            <MainCard>
                ...
                >
                    ...
                    {pathname !== "/barang-retur" && pathname !== "/barang-retur/tambah-barang-retur" && pathname !== "/barang-retur/edit-barang-retur" && (
                        <div className="d-flex justify-content-end align-items-center">
                            <Link to={"edit-barang-retur"} state={{ id: id }} className="text-decoration-none d-flex align-items-center">
