...
export const patchBarangRetur = async (req, res) => {
    ...
    //         const volumeBarang = await Produk.find({ _id: id_produk }, { volume: 1, _id: 0 });
    //         const idRak = await Produk.find({ _id: id_produk }, { id_rak: 1, _id: 0 });

    //         const getTotalStokBarang = totalStokBarang[0].stok.total;
    //         const getVolumeBarang = volumeBarang[0].volume;
    //         const getIdRak = idRak[0].id_rak;

    //         const rakSusun = await Rak.find(
    //             {
    //                 "susun._id": getIdRak,
    //             },
    //             {
    ...
    //         let totalStokBaru;
    //         let totalVolumeProduk = jumlah * getVolumeBarang;
    //         let totalVolumeProdukDiproses = jumlahDiproses * getVolumeBarang;
    //         let hitungKapasitasTerpakai;
    //         let hitungPersentase;

    //         if (status === "Diterima Ganti Barang") {
    //             if (jumlah === jumlahDiproses) {
    //                 totalStokBaru = Number(getTotalStokBarang) + Number(jumlah);
    //                 hitungKapasitasTerpakai = Number(terpakaiRakSusun) + Number(totalVolumeProduk);
    //                 hitungPersentase = (Number(totalVolumeProduk) / Number(kapasitasRakSusun)) * 100 + Number(statusRakSusun);
    ...
    //                 );
    //             } else {
    //                 totalStokBaru = Number(getTotalStokBarang) + Number(jumlahDiproses) - Number(jumlah) + Number(jumlah);
    //                 hitungKapasitasTerpakai = Number(terpakaiRakSusun) - Number(totalVolumeProdukDiproses) + Number(totalVolumeProduk);
    //                 hitungPersentase = (Number(totalVolumeProduk) / Number(kapasitasRakSusun)) * 100 + (Number(statusRakSusun) - (Number(totalVolumeProdukDiproses) / Number(kapasitasRakSusun)) * 100);
    ...
    //             if (jumlah === jumlahDiproses) {
    //                 // totalStokBaru = Number(getTotalStokBarang);
    //                 // hitungKapasitasTerpakai = Number(terpakaiRakSusun);
    ...
    //                 );
    //             } else {
    //                 // totalStokBaru = Number(jumlahDiproses) - Number(jumlah) + Number(getTotalStokBarang);
    //                 // hitungKapasitasTerpakai = ;
